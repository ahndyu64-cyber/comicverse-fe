  ...
  return (
    <main className="min-h-screen bg-white dark:bg-neutral-950">
      <div className="mx-auto max-w-4xl px-4 py-16">
        <h1 className="text-4xl font-bold text-neutral-900 mb-8">Về chúng tôi</h1>
        
        <div className="max-w-none text-neutral-700 dark:text-neutral-300 space-y-6">
          <section>
            <h2 className="text-2xl font-bold text-neutral-900 mb-4">ComicVerse là gì?</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-neutral-900 mb-4">Sứ mệnh của chúng tôi</h2>
            <p className="text-neutral-700 dark:text-neutral-300">
          ...
          <section>
            <h2 className="text-2xl font-bold text-neutral-900 mb-4">Tại sao chọn ComicVerse?</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-neutral-900 mb-4">Liên hệ với chúng tôi</h2>
            <p className="text-neutral-700 dark:text-neutral-300">
