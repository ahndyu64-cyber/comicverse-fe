  ...
  return (
    <div className="relative flex items-center">
      <input
        ...
        className="rounded-md border border-white/30 bg-white/20 px-3 py-1 text-sm text-black placeholder-neutral-500 outline-none focus:bg-white/30 focus:border-white/50 transition-colors"
