...
export default function ManhwaComicsList() {
  ...
  useEffect(() => {
    if (scrollContainerRef.current && manhwaComics.length > 0) {
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            <button
              ...
              className="w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center rounded-full border-2 border-neutral-300 dark:border-neutral-700 text-neutral-900 dark:text-white hover:border-red-600 dark:hover:border-red-600 transition-all duration-300"
            >
