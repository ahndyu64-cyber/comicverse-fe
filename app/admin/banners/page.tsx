                ...
                <div key={banner._id} className="p-6">
                  {editingId === banner._id ? (
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                      <img src={banner.src} alt="banner" className="w-full sm:w-40 sm:h-24 h-24 object-cover rounded-lg flex-shrink-0" />
                      ...
                      <div className="flex gap-2 w-full sm:w-auto flex-col sm:flex-row">
                        <button
                          ...
                          className="w-full sm:w-auto inline-flex items-center justify-center gap-1.5 rounded-lg bg-gradient-to-br from-red-100 to-red-50 text-red-700 px-3 py-1.5 text-sm font-semibold hover:from-red-200 hover:to-red-100 transition shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
                        >
