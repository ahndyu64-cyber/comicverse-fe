                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className="rounded-lg bg-amber-50 text-amber-700 px-3 py-1 text-sm font-semibold hover:bg-amber-100 transition"
                        >
                          Sửa
                        </button>
                        <button
                          ...
                          className="rounded-lg bg-red-50 text-red-700 px-3 py-1 text-sm font-semibold hover:bg-red-100 disabled:opacity-50 transition"
                        >
